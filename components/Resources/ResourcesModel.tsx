...
export class ResourceModel extends Model {
    ...
    async getRecord(id: string) {
        return getRecord(this.schema, this.table,
            ['id','name','description','status','created_at','created_by',
              ...
              'resource_collection_id', 'resource_collection.name' ], 
            id);  
    }
    ...
    async delete(id:string)  {
        ...
        */        
        // delete labels of resource not wait execure
        ...
        // delete resource record, return promise
