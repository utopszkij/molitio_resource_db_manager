...
const _Collections = ( params: any ): React.JSX.Element => {
    ...
    const getItems = (newStatus: string, newOffset?:number) => {
        ...
        getRecords('resource_schema', 'resource_collection',
    ...
    const getTotalCount = (newStatus: string) => {
        getTotal('resource_schema', 'resource_collection',
            browserInfo.filter
        ).then( (res) => { 
            res = preprocessor(res);
            if (res.error != undefined) {
                    ...
                    {(compStatus == 'browser') && 
                        <div className="browser">
                            ...
                            <table className={Styles.brTable}>
                                ...
                                { formData.items.map( (item: CollectionsRecord, index) => 
                                    <tr key={index}>
                                        <td>
